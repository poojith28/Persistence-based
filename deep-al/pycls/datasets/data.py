...
from pycls.datasets.balanced_cifar import BALANCEDCIFAR10
...
class Data:
    ...
    def __init__(self, cfg):
        ...
        """
        self.cfg = cfg
        self.num_workers = 4 # cfg.DATA_LOADER.NUM_WORKERS
    ...
    def getPreprocessOps(self):
        ...
        if self.dataset in self.datasets_accepted:
            ...
            if self.dataset in ["CIFAR10", "CIFAR100", 'IMBALANCED_CIFAR10', 'IMBALANCED_CIFAR100','BALANCED_CIFAR10']:
            ...
            elif self.dataset == 'BALANCED_CIFAR10':
    ...
    def getDataset(self, save_dir, isTrain=True, isDownload=False):
        ...
        """
        print(f"Dataset provided: {self.dataset}")
        self.eval_mode = True
        ...
        if self.dataset == "MNIST":
            ...
            balanced_cifar10 = BALANCEDCIFAR10(
        save_dir,
        train=isTrain,
        ...
        only_features=only_features
            ...
            return balanced_cifar10, len(balanced_cifar10)
    ...
    def getIndexesDataLoader(self, indexes, batch_size, data):
        ...
        loader = MultiEpochsDataLoader(dataset=data, num_workers=4, batch_size=batch_size,
