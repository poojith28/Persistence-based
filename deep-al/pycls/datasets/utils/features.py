    ...
    'train':
        {
            ...
            'BALANCED_CIFAR10':'../../scan/results/cifar-balanced/pretext/features_seed{seed}.npy',
    ...
    'test':
        {
            ...
            'BALANCED_CIFAR10': '../../scan/results/cifar-balanced/pretext/test_features_seed{seed}.npy' ,
